    ...
    <>
      ...
      <AnimatePresence>
        {sidebarOpen && (
          ...
          >
            <div className="flex items-center justify-between px-4 py-5 bg-gradient-to-r from-green-600 to-emerald-600">
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:shrink-0 bg-white border-r border-gray-100">
        <div className="flex items-center h-16 px-6 bg-gradient-to-r from-green-600 to-emerald-600">
          <div className="text-white font-semibold text-lg">Delivery Person</div>
        </div>
